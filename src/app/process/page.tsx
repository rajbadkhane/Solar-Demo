      ...
      <main className="solar-container pb-20 pt-10">
        <Reveal>
          <section className="soft-card section-glow p-8 md:p-10">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-amber-700">Execution Workflow</p>
          ...
          {phases.map((phase, i) => (
            <Reveal key={phase.title} delayMs={i * 110}>
              <article className="soft-card section-glow flex flex-col gap-3 p-6 md:flex-row md:items-start md:justify-between">
                <h2 className="text-2xl font-bold text-amber-900 md:w-1/3">{phase.title}</h2>
        ...
        <Reveal delayMs={260}>
          <section className="mt-8 overflow-hidden rounded-3xl bg-[linear-gradient(120deg,#112b7d,#2147aa)] p-8 text-white md:p-10">
            ...
            <p className="mt-3 text-amber-100">Commercial projects follow a customized milestone plan based on capacity, civil conditions, and statutory lead times.</p>
